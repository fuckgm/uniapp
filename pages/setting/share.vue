<template>
	<view>
		...
		<view class="m-30 p-30 border-radius-20 bg-black text-white" style="    overflow: hidden;
    padding-top: 0px;
    position: relative;
    background-image: url(/h5/static/img/home-bg.a827cafe.png);
			...
			<view class="d-flex  align-items-center">
				...
				<view class="ml-22">
					...
					<text class="d-block font-size-22 opacity-50 mt-4"
						v-if="user.score">{{i18n.score}}:{{Number(user.score)}}
						<p></p>
						</text>
						<text class="d-block font-size-22 opacity-50 mt-4" >Invitation code: {{this.user.extension_code}}</text>
				</view>
			</view>
			<view class="mt-50 mx-auto text-center p-30 bg-333 border-radius-20" style="width: 330px;    background-color: #33333300 !important;">
