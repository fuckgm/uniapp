<template>
	<view class="pb-50 text-white">
		...
		<view class="deposit mt-30 mx-30" style="background-image:linear-gradient(1deg, #FFCC8F 0%, #FFEDD8 100%);">
		...
		<view class="m-30">
			...
			<view class="p-30 box-shadow border-radius-20 mt-30  bg-black">
