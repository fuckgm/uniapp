export default {
	...
	demo:'DemoAccount',
			real:'RealAccount',
	nav: ['Página principal', 'Cotización', 'Comercio',  'Activos'],
	common: {
        souye1: 'Chọn một cặp giao dịch giao ngay Energy cụ thể và tận hưởng phí giao dịch bằng không',
        suoye2: 'Tạo danh mục đầu tư tiền điện tử cá nhân! ',
        souye3: 'Bắt ​​đầu sử dụng',
		shuoming:'Póngase en contacto con el servicio de atención al cliente antes de recargar',
		profit:'lucro',
		search: "Buscar",
		confirm: "Determinar",
		cancel: "Cancelar",
	...
	home: {
		fnttongzhi: '¡Predicción de venta de NFT! ',
fntshuoming: '¡La venta de colecciones, cajas ciegas y subastas en NFT requiere una revisión oficial del servicio al cliente! Si no puede acceder a su cuenta la primera vez, comuníquese con el servicio al cliente para verificar la dirección hash a tiempo. ¡Los NFT vendidos después de la verificación oficial se pueden acreditar en la cuenta! ',
	...
	setting: {
		...
		authentication_text_4: "Después de la certificación puede reflejar, límite de 24 horas 20000 USDT",
		...
		authentication_text_7: "Aumento del límite de presentación, límite de 24 horas 500USDT",
	...
	invest: {
		...
		shuoming_3: 'Si el precio de liquidación es inferior al precio vinculado, el USDT se liquidará al vencimiento; Cantidad de liquidación = cantidad de inversión * (1 + días * rendimiento anualizado / 365).',
