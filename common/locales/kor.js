export default {
	DOT:'Nuclear energy',
		...
		demo:'DemoAccount',
				real:'RealAccount',
	nav: ['첫 페이지', '시세', '트레이드',  '자산'],
	common: {
		souye1: '특정 비트코인 Energy 현물 거래 쌍을 선택하고 거래 수수료 제로 즐기기',
        suoye2: '개인 암호화폐 포트폴리오를 만드세요! ',
        souye3: '사용 시작', 
		shuoming:'충전하기 전에 고객 서비스에 문의하십시오',
		profit:'이익',
		search: "수색하다",
		confirm: "확정하다",
		cancel: "취소",
	...
	home: {
		fnttongzhi: 'NFT 판매 예측! ',
        fntshuoming: 'NFT에서 컬렉션, 블라인드 박스 및 경매를 판매하려면 공식 고객 서비스 검토가 필요합니다! 처음에 계정에 접속이 안 되시면 고객센터로 연락하셔서 해시 주소를 제때 확인해주세요! 공식 인증 후 판매된 NFT는 계좌로 입금 가능합니다! ',
		contactUs: '연락처',
		borrowing: '차용',
	...
	setting: {
		...
		authentication_text_4: "24시간 한도 20000 USDT 인증 후 제공",
		authentication_text_5: "인증 후 법정 통화 거래 가능, 1회 50000 USDT",
		authentication_text_6: "Lv2.고급 인증",
		authentication_text_7: "구현 한도 증가, 24시간 한도 500USDT",
	...
	invest: {
		...
		shuoming_3: "정산가<연계가격>이면 만기가 되면 USDT를 정산합니다.결제수량=투자금액*(1+일수*연간수익률/365).",
