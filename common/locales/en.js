export default {
	...
	energy:'Energy',
		...
		demo:'DemoAccount',
		real:'RealAccount',
	nav: ['Home', 'Markets', 'Trade',  'Assets'],
	common: {
		souye1: 'Select a specific Energy spot trading pair and enjoy zero transaction fees',
		suoye2: 'Create a personal portfolio! ',
		souye3: 'Start using',
		shuoming:'Please contact customer service before recharging',
		profit:'profit',
		search: 'Search',
		confirm: "OK",
		cancel: "Cancel",
	...
	home: {
		fnttongzhi: 'NFT sale prediction! ',
		fntshuoming: 'Selling collections, blind boxes, and auctions on NFTs requires official customer service review! If you can\'t get to your account at the first time, please contact customer service to check the hash address in time! NFTs sold after official verification can be credited to the account! ',
	...
	setting: {
		...
		banksOther: "Bank Card Binding - Other",
		...
		authentication_text_4: 'It can be reflected after authentication, the 24-hour limit is 20000 USDT',
		authentication_text_5: 'After authentication, fiat currency transactions can be performed, with a single limit of 2000 USDT',
		authentication_text_6: 'Lv2. Advanced Authentication',
		authentication_text_7: 'Increase the credit limit, the 24-hour limit is 50000 USDT',
	...
	transaction: {
		...
		secondsPosition: 'Options position',
		position: 'holding',
		history: 'History',
	...
	fund: {
		...
		withdrawToCardOther: 'Other Card',
	...
	invest: {
		...
		shuoming_3: 'If settlement price＜pegged price, USDT will be settled after expiration; settlement amount=investment amount*(1+days*annualized rate of return/365).',
	...
	nft: {
		...
		position: 'hold',
		resell: 'resell',
		confirPurchase:'Purchase confirmation',
		buyPrice: 'buy price',
