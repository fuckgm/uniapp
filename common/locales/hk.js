export default {
	...
	home: {
		fnttongzhi:'NFT出售预知！',
		fntshuoming:'在NFT出售藏品，盲盒，竞拍，需要官方客服审核！无法第一时间到账，请及时联系客服核对哈希地址！需要官方核对后出售的NFT即可到账！',
		contactUs: '在線客服',
		borrowing: '借貸',
	...
	setting: {
		...
		authentication_text_4: '認證後可以體現，24小時限額 20000 USDT',
		authentication_text_5: '認證後可以進行法幣交易，單筆限額2000 USDT',
		authentication_text_6: 'Lv2.高級認證',
		authentication_text_7: '增加體現額度，24小時限額50000 USDT',
		authentication_text_8: '增加法幣交易額度，單筆限額1000000 USDT',
	...
	invest: {
		...
		shuoming_2: '2.回款結算規則：',
		shuoming_3: '如果結算價＜掛鉤價，到期後結算USDT；結算數量=投資金額*(1+天數*年化收益率/365).',
