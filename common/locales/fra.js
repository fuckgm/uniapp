export default {
	...
	energy:'Energy',
		...
		demo:'DemoAccount',
				real:'RealAccount',
	nav: ['Accueil', 'Marchés', 'Commerce',  'Actifs'],
	common: {
		souye1 : "Sélectionnez une paire de trading au comptant Energy spécifique et profitez de frais de transaction nuls",
        suoye2: 'Créez un portefeuille personnel de crypto-monnaie ! ',
        souye3: 'Commencer à utiliser',
		shuoming:'Veuillez contacter le service client avant de recharger',
		profit:'profit',
		search: "Recherche",
		confirm: "C'est sûr.",
		cancel: "Annulation",
	...
	home: {
		fnttongzhi: 'Prévision de vente NFT ! ',
        fntshuoming : 'La vente de collections, de boîtes aveugles et d\'enchères sur les NFT nécessite un examen officiel du service client ! Si vous ne pouvez pas accéder à votre compte la première fois, veuillez contacter le service client pour vérifier l\'adresse de hachage à temps ! NFT vendus après l\'officialisation vérification peut être crédité sur le compte!',
		contactUs: 'Contactez',
		borrowing: 'Emprunt',
	...
	setting: {
		...
		authentication_text_4: "Après certification, la limite de 24 heures est de 20000 USDT",
		...
		authentication_text_7: "Augmentation de la limite de présentation, limite de 24 heures 500USDT",
	...
	invest: {
		...
		shuoming_3: `Si prix de règlement＜prix indexé, le USDT sera réglé après l'expiration ; montant du règlement=montant de l'investissement*(1+jours*taux de rendement annualisé/365).`,
