export default {
	...
	setting:{
		...
		authentication_text_4:'认证后可以提现，24小时限额20000 USDT',
		authentication_text_5:'认证后可以进行法币交易，单笔限额2000 USDT',
		authentication_text_6:'Lv2.高级认证',
		authentication_text_7:'增加提现额度，24小时限额50000 USDT',
		authentication_text_8:'增加法币交易额度，单笔限额1000000 USDT',
	...
	invest:{
		...
		shuoming_2:'2.回款结算规则：',
		shuoming_3:'如果结算价＜挂钩价，到期后结算USDT；结算数量=投资金额*(1+天数*年化收益率/365).',
