export default {
	...
	nav: ['ホーム','市場','貿易','資産'],
	common: {
		souye1:'特定のビットコイン Energy スポット取引ペアを選択し、ゼロの取引手数料をお楽しみください',
        suoye2:'個人の暗号通貨ポートフォリオを作成してください！ ',
        souye3:'使い始める',
		shuoming:'充電する前にカスタマーサービスに連絡してください',
		profit:'利益',
		search: "検索",
		confirm: "を選択します。",
		cancel: "キャンセル",
	...
	home: {
		fnttongzhi:'NFT販売予測！ ',
        fntshuoming:'NFTでコレクション、ブラインドボックス、オークションを販売するには、公式のカスタマーサービスレビューが必要です。初めてアカウントにアクセスできない場合は、カスタマーサービスに連絡して、時間内にハッシュアドレスを確認してください。正式な確認後に販売されたNFTは、アカウントに入金できます。 ',
		contactUs: 'お問い合わせ',
		borrowing: '借りる',
	...
	setting: {
		...
		authentication_text_4: "認証後、24時間限定20000 USDT",
		authentication_text_5: "認証後はフランスドル取引が可能で、単筆限度2000 USDT",
		authentication_text_6: "Lv2.高度な資格認定",
		authentication_text_7: "体現額を増やし、24時間限度額500 USDT",
	...
	invest: {
		...
		shuoming_3: `決済価格<ペッグ価格の場合、USDTは満了後に決済されます;決済金額=投資金額*（1+日*年間収益率/365）。`,
